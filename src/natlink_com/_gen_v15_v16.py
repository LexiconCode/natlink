# -*- coding: utf-8 -*-
"""Vendored comtypes-generated wrappers for Dragon interfaces (DPI 15 / DPI 16).

Auto-generated from dragon_interfaces_v15_v16.tlb via comtypes.client.GetModule().
...
assert sizeof(__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0013) == 72, sizeof(__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0013)
...
class IVoiceDictation0W(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SiteInfoGet(self, p0: hints.Incomplete) -> hints.Incomplete: ...
...
class IDgnSSvcInterpreterA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def CheckScript(self, p0: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def ExecuteScript(self, p0: hints.Incomplete, p3: hints.Incomplete, p4: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def ExecuteScriptWithListResults(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p5: hints.Incomplete, p6: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class Library(object):
    """Dragon/SAPI Marshal Interfaces (DNS 15+)"""
    name = 'DragonProxyStubLib_v15_v16'
    _reg_typelib_ = ('{DD100100-6205-11CF-AE61-0000E8A28647}', 2, 0)
...
class IDgnSRResGraphA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def GetWordNode(self, p0: hints.Incomplete, p3: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
...
class IDgnSRLexiconA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def WordTest(self, p0: hints.Incomplete, p1: hints.Incomplete) -> hints.Incomplete: ...
...
assert sizeof(__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0014) == 72, sizeof(__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0014)
...
class IDgnSREngineControlA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def GetVersion(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def GetMicState(self) -> hints.Incomplete: ...
        ...
        def GetChangedInfo(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IVoiceDictation0A(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SiteInfoSet(self, p0: hints.Incomplete, p1: hints.Incomplete) -> hints.Hresult: ...
        def SessionSerialize(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def TopicEnum(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def TopicAddString(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete) -> hints.Hresult: ...
        def TopicAddGrammar(self, p0: hints.Incomplete, p1: hints.Incomplete) -> hints.Hresult: ...
        def TopicRemove(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def TopicSerialize(self, p0: hints.Incomplete) -> hints.Hresult: ...
...
IVoiceDictation0A._methods_ = [
    ...
    COMMETHOD(
        ...
        HRESULT,
        'TopicEnum',
        (['out'], POINTER(POINTER(VDCTTOPICA)), 'p0'),
        (['out'], POINTER(c_ulong), 'p1')
    ),
    COMMETHOD(
        [],
...
class IDgnSSvcOutputEventA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def Register(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def PlayString(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p3: hints.Incomplete, p5: hints.Incomplete) -> hints.Incomplete: ...
        ...
        def PlayEvents(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p3: hints.Incomplete, p4: hints.Incomplete) -> hints.Hresult: ...
...
#         #return 
#
#     def PlayString(self, p0, p1, p2, p3, p5):
#         '-no docstring-'
#         #return p4
#
...
#         #return p4, p5
#
#     def PlayEvents(self, p0, p1, p2, p3, p4):
#         '-no docstring-'
#         #return 
#
...
class IDgnSRSpeakerA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def EnumBaseModels(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def New(self, p0: hints.Incomplete, p1: hints.Incomplete) -> hints.Hresult: ...
        def GetSpeakerDirectory(self, p0: hints.Incomplete, p2: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class IDgnLexWordA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def Add(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p3: hints.Incomplete) -> hints.Hresult: ...
        def GuessPartOfSpeechandAdd(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p3: hints.Incomplete, p4: hints.Incomplete) -> hints.Hresult: ...
        def GuessPartOfSpeech(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete) -> hints.Incomplete: ...
        def Get(self, p0: hints.Incomplete, p3: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def Remove(self, p0: hints.Incomplete) -> hints.Hresult: ...
...
class IDgnSSvcOutputEventW(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def Register(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def PlayString(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p3: hints.Incomplete, p4: hints.Incomplete, p5: hints.Incomplete) -> hints.Incomplete: ...
        def NameFromKey(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p3: hints.Incomplete, p5: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def PlayEvents(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete, p3: hints.Incomplete, p4: hints.Incomplete) -> hints.Hresult: ...
...
class IVDct0TextA(comtypes.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def TextRemove(self, p0: hints.Incomplete, p1: hints.Incomplete, p2: hints.Incomplete) -> hints.Hresult: ...
        def TextSelSet(self, p0: hints.Incomplete, p1: hints.Incomplete) -> hints.Hresult: ...
        def TextSelGet(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def GetChanges(self) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def BookmarkAdd(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def BookmarkRemove(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def BookmarkMove(self, p0: hints.Incomplete, p1: hints.Incomplete) -> hints.Hresult: ...
        def BookmarkQuery(self, p0: hints.Incomplete) -> hints.Incomplete: ...
        def BookmarkEnum(self, p0: hints.Incomplete, p1: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def Hint(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def Words(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def ResultsGet(self, p0: hints.Incomplete, p1: hints.Incomplete) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def AutoLockSet(self, p0: hints.Incomplete) -> hints.Hresult: ...
        def AutoLockGet(self) -> hints.Incomplete: ...
...
IVDct0TextA._methods_ = [
    ...
    COMMETHOD(
        ...
        (['in'], c_ulong, 'p0'),
        (['in'], c_ulong, 'p1'),
        (['out'], POINTER(POINTER(VDCTBOOKMARK)), 'p2'),
        (['out'], POINTER(c_ulong), 'p3')
    ),
    COMMETHOD(
        [],
...
__all__ = [
    'SRGRMFMT_DICTATIONNATIVE', 'ISRResGraphW',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0017', 'SRPHRASEA',
    'VDSITEINFOA', 'IDgnVDctTextA', 'IVDct0TextW', 'VPS_DETERMINER',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0010',
    'SRRESWORDNODE', 'IDgnSREngineNotifySinkW', 'VPS_PUNCTUATION',
    'CHARSET_IPAPHONETIC', 'IDgnSRWordEnumW',
    'SRGRMFMT_LIMITEDDOMAIN', 'IDgnSSvcInterpreterA',
    'IDgnSRGramSelectA',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0020',
    'VPS_PREPOSITION', 'ILexPronounceW', 'ISRGramCFGA', 'ISRCentralA',
    'IDgnSRAudioFileSourceA',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0016',
    'SRGRMFMT_DRAGONNATIVE3', 'typelib_path',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0023',
    'VPS_CONJUNCTION', 'VPS_CARDINAL', 'IDgnErrorW', 'ISRResBasicA',
    'IDgnSRGramDictationW', 'IDgnVDctTextW', 'ISRResAudio',
    'VPS_CONTRACTION',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0002',
    'DGNSRRESWORDNODE',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0019',
    'IDgnSRWordPrefixEnumA', 'IDgnSSvcInterpreterW',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0001',
    'SRGRMFMT_DRAGONNATIVE1', 'IDgnSRLexiconA',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0015',
    'IDgnSRTopic2W', 'VPS_UNKNOWN', 'HOOK_EVENTMSG', 'IVDct0TextA',
    'IDgnSRLexiconW', 'SRGRMFMT_CFGNATIVE', 'POSINFO',
    'IDgnSRTopic2A',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0018',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0005',
    'IVoiceDictation0W', 'IDgnSREngineControlW',
    'IDgnSRWordPrefixEnumW', 'ISRGramCommonA', 'VPS_QUANTIFIER',
    'SRGRMFMT_LIMITEDDOMAINNATIVE', 'VOICECHARSET', 'ISRSpeakerW',
    'IDgnSRTrainingA', 'CHARSET_TEXT', 'VPS_PRONOUN',
    'IDgnSRAudioFileSourceW', 'VPS_ABBREVIATION', 'IDgnSRResGraphW',
    'SRGRMFMT_CFG',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0014',
    'IDgnVDctNotifySink',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0006', 'VPS_VERB',
    'SRGRMFMT', 'IDgnSSvcOutputEventA', 'ISRNotifySink',
    'IDgnSREngineControlA', 'IDgnSRSpeakerW',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0011',
    'ISRGramCFGW',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0007',
    'ISRGramNotifySinkW', 'SRGRMFMT_DICTATION', 'ISRSpeakerA',
    'ISRGramDictationW', 'VPS_PROPERNOUN', 'SRMODEINFOA',
    'IDgnSRGramSelectW', 'VOICEPARTOFSPEECH', 'ISRResBasicW',
    'ISRResCorrectionA', 'VPS_ORDINAL', 'CHARSET_ENGINEPHONETIC',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0012',
    'IDgnSRResSelect', 'IVoiceDictation0A', 'Library',
    'ISRGramCommonW', 'VDCTBOOKMARK', 'ISRResMemory', 'SRMODEINFOW',
    'VPS_ADJECTIVE', 'VDCTTOPICW', 'LANGUAGEA', 'IDgnLexWordA',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0004',
    'ISRGramDictationA', 'SAPI_POSTYPE', 'ISRCentralW',
    'ISRGramNotifySinkA', 'SRPHRASEW', 'IDgnSRResGraphA',
    'IDgnGetSinkFlags', 'IDgnExtModSupStringsW', 'ISRResGraphA',
    'SRGRMFMT_DRAGONNATIVE2', 'SRRESPHONEMENODE',
    'IDgnSSvcOutputEventW', 'IDgnSRWordEnumA', 'VPS_NOUN',
    'DGN_ERROR_W',
    '__MIDL___MIDL_itf_dragon_interfaces_0000_0000_0024',
    'IDgnSRGramCommon', 'IDgnSSvcActionNotifySink', 'VDCTTOPICA',
    'ISRResCorrectionW', 'VPS_INTERJECTION',
    ...
    'VPS_ADVERB', 'IVDct0NotifySinkA', 'IDgnSRSpeakerA',
    'IDgnSREngineNotifySinkA', 'SDATA', 'IDgnExtModSupStringsA',
    'ILexPronounceA', 'IDgnSRGramDictationA', 'IDgnLexWordW'
]
